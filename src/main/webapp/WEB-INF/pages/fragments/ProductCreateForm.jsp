<div id="form" style="width: 750px; margin-left:auto; margin-right:auto;">
	<div class="w2ui-page page-0">
		...
		<div class="w2ui-field">
			<textarea name="shortdesc" style="width: 385px; height: 80px; resize: none" ></textarea>
		</div>
		<div class="w2ui-label">Long Description:</div>
		<div class="w2ui-field">
			<textarea name="longdesc" style="width: 385px; height: 180px; resize: none" ></textarea>
		</div>
	</div>
	...
	$(function() {
		$('#form').w2form({
			...
			fields : [ {
				...
				type : 'select',
				required : true, 
				options : { items : ['Kilogram', 'Gram', 'Pound', 'Ounce']}
			}, {
				name : 'lengthclass',
				type : 'select',
				required : false,
				options : { items : ['Centimeter', 'Milimeter', 'Inch']}
			}, {
				name : 'length',
				type : 'float',
				required : false
