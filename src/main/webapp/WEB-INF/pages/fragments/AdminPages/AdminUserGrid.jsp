...
<div class="row-fluid">
	<div id='jqgrid' class="span12">
		...
		<div id="userbuttons" style="clear: both; margin: 10px 0 10px 10px;">
			<input type="button" id="AddUser" Value="Add User" /> <input
				type="button" id="EditUser" Value="View/Edit User" /> <input
				type="button" id="DeleteUser" Value="Delete User" /> <input
				type="button" id="SearchUser" value="Search User" />
		</div>
	</div>
</div>
