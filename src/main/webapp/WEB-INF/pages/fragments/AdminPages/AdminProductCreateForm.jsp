...
<div class="row-fluid pull-left">
	<div id="productcreateeditform" class="span12" style="width: 100%; height: 550px;">
...
<spring:url value="/static/js/ImageChooseController.js" htmlEscape="true"
		var="ImageChooseControllerJs"/>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" data-keyboard="false"
	aria-labelledby="myModalLabel" aria-hidden="true" ng-app="imageFetchDialogApp" ng-controller='PicasaController'>
	...
	<div class="modal-body">
		<div class="row-fluid" >
			<div class="span3"> 
				<ul>
					<li ng-repeat='album in albums'><a ng-click="retrievePics(album.value)">{{album.key}}</a></li>
				</ul>
			</div>
			<div class="span9"> 
				<ol id="selectable">
					<li  ng-repeat="photo in photos"><img src='{{photo}}' width='120' height='90'/></li>
				</ol>
			</div>
		</div>
	</div>
	<div class="modal-footer">
		...
		<button class="btn btn-primary" onclick="selectPhoto()">Select Image</button>
	</div>
</div>
